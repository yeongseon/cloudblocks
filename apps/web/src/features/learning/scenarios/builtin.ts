...
const threeTierCheckpointWithBlocks: ArchitectureSnapshot = {
  ...
  nodes: [
    ...
    },
    {
      ...
      category: 'data',
      provider: 'azure',
      parentId: 'plate-scn3tier-subnet2',
