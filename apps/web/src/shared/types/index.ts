...
> = {
  ...
  security: {
    ...
    connections:
      'Connects to compute and data blocks via internal or data connections for policy enforcement.',
  },
  edge: {
    what: 'Load balancers and CDNs distribute incoming traffic across backend compute instances for high availability.',
    placement:
      'Place in a subnet to receive external traffic. Routes to compute blocks in other subnets.',
    connections:
  ...
  data: {
    ...
    connections:
      'Receives data connections from compute blocks. May replicate via async connections.',
  },
  messaging: {
    ...
    connections:
      'Receives async connections from producers. Sends async connections to consumer compute blocks.',
  },
  operations: {
