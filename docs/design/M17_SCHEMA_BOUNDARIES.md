...
| `SUBTYPE_REGISTRY`     | L21–58         | _none in index.ts_     | Backend-only; keys use `ProviderType` × `BlockCategory`                      |
| JSON Schema (embedded) | L300–415       | _none_                 | Inline schema string duplicates enum values                                  |
